...
def downgrade() -> None:
    for table in [
        "sales_document_lines", "sales_documents", "stock_snapshots", "branches", "products", "integration_outbox_events", "integration_errors", "integration_raw_objects", "integration_mappings", "integration_job_runs", "integration_jobs", "integration_connections", "tenants",
    ]:
        op.drop_table(table)
